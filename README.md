...
<head>
  ...
  <title>Mitra Putra Bangsa - Program Kemitraan Bapenda untuk UKM</title>
  <style>
    body {
    ...
    /* Logo header kanan lebih besar */
    .header-logo img {
      height: 180px;  /* atur ukuran logo besar */
      width: auto;
    }
    main {
      max-width: 900px;
